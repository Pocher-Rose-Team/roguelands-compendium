...
const Store: React.FC = () => {
    ...
    useEffect(() => {
        ...
        itemService.getLeastUsedItems(selectedType).subscribe((data: Item[]) => setLeastUsedItems(data));
    }, [selectedType, items]);
    ...
    return (
        <Box>
            ...
            <Box display="flex" justifyContent="space-between" marginBottom={2}>
                <RogueButton text="All" onClick={() => handleTypeChange(undefined)} />
                <RogueButton text="Armor" onClick={() => handleTypeChange(ItemType.ARMOR)} />
                <RogueButton text="Droids" onClick={() => handleTypeChange(ItemType.DROIDS)} />
                <RogueButton text="Helmets" onClick={() => handleTypeChange(ItemType.HELMETS)} />
                <RogueButton text="Shields" onClick={() => handleTypeChange(ItemType.SHIELDS)} />
                <RogueButton text="Weapons" onClick={() => handleTypeChange(ItemType.WEAPONS)} />
                <RogueButton text="Help Me" onClick={() => handleOpenHelpDialog}></RogueButton>
            </Box>
